...
class Routine:
    ...
    They wait for a condition to be met before executing the routine instance(s).
    Routines can be stopped, started, and paused.
    Routines are blocking and will run on separate threads (Thread Pool Executor / Process Pool Executor).
    """
    def __init__(
            self, 
            name: str, 
